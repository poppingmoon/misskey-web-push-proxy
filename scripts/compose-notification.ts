...
export function composeNotification(
  ...
  switch (data.type) {
      ...
      switch (body.type) {
        ...
        case "achievementEarned":
          return {
            ...
            bodyLocKey:
              `_achievements._types._${body.achievement}.title` as LocKey,
            ...notification,
          };
        case "login":
          return {
    ...
    case "newChatMessage": {
      ...
      if (body.toRoomId) {
        return {
          title: `${body.toRoom.name}: ${getNameOrUsername(body.fromUser)}`,
          body: body.text ?? "",
          image: body.fromUser.avatarUrl,
          ...notification,
        };
      } else {
        return {
          title: getNameOrUsername(body.fromUser),
          body: body.text ?? "",
          image: body.fromUser.avatarUrl,
          ...notification,
        };
